        ...
        <div className="flex flex-col gap-8 items-center text-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-2">
            <a href="#contact" className="inline-block">
              <Button size="lg" className="text-base h-12 px-8 bg-blue-600 text-white hover:bg-blue-700 shadow-lg shadow-blue-600/20 hover:-translate-y-0.5 transition-all">
                お問い合わせ・資料請求
              </Button>
            </a>
          </div>
